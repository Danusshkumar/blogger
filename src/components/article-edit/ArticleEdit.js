...
import { summarizeText } from "../header/services/SummarizeService";
...
class ArticleEdit extends Component {
  ...
  toggleStyleOfPreviewer (currentMode) {
    ...
    // New handleUpdate function to update markdown state
    handleUpdate = (summarizedText) => {
      this.setState({
        markdown: summarizedText,
        htmlOutput: MarkdownParser.render(summarizedText)
      });
    };  
            ...
            ? (
              <div>
                ...
                <Header
                  ...
                  handleUpdate={this.handleUpdate}  // Pass the handleUpdate function here
                />
                {/* adding div to match the toobar header*/}
